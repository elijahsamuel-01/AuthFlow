...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full h-screen bg-white">
      ...
      <div className="border rounded-md w-[400px] min-h-[300px] shadow-sm mx-4 bg-orange-500 border-solid border-2 border-black">
        <form className="pl-4 mt-8" onSubmit={onHandleSubmit}>
          ...
          <div className="w-[95%]">
            <button
              className="w-full flex bg-gray-900 rounded-sm justify-center py-3 text-white duration-300 transition-all hover:shadow-md "
              type="submit"
            >
